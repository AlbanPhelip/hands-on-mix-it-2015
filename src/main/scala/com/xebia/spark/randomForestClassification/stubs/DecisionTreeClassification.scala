...
import com.xebia.spark.randomForestClassification.stubs.modelling.TreeModelling.decisionTreeTrainClassifier
...
object DecisionTreeClassification {
  ...
  def main(args: Array[String]) {
    ...
    // -------- Training the model
    // TODO : use the decisionTreeTrainClassifier method to train a Decision Tree (Use the parameters of your choice)
